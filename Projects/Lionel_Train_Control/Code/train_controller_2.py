...
# This project controls a Lionel train switch using the Raspberry Pi and an iFrogLab ArBle.  
# See more documentation on our website at https://www.ifroglab.com/
...
while True:	# Run a forever loop.  Just run until we run into an error.
	try:
		...
		#Send Serial data to iFrogLab ArBle
